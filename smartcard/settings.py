...
SECRET_KEY = 'django-insecure-=4@1k%zl(p7vxx$=k)*vyd*n2h2lgln)zmaaf7a)r09ow_w!@v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # ✅ Global templates folder path added
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DEFAULT_FROM_EMAIL = "Smart NFC <no-reply@example.com>"

# SMTP example (production) - uncomment & configure when ready
